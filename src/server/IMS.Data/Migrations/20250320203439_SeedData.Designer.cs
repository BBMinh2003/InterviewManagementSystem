...
namespace IMS.Data.Migrations
{
    ...
    [Migration("20250320203439_SeedData")]
            ...
            modelBuilder.Entity("IMS.Models.Security.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("11111111-aaaa-aaaa-aaaa-aaaaaaaaaaaa"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "beba586a-e7ca-4284-9c2d-adab20eb8812",
                        ...
                        new
                        {
                            Id = new Guid("22222222-bbbb-bbbb-bbbb-bbbbbbbbbbbb"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "108ef164-80a7-42ec-9447-f0c633bf0264",
                        ...
                        new
                        {
                            Id = new Guid("33333333-cccc-cccc-cccc-cccccccccccc"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "74f95d79-1d2e-4d4c-909a-cb420471e376",
                            CreatedAt = new DateTime(2024, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateOfBirth = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("44444444-dddd-dddd-dddd-dddddddddddd"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0150892f-8ca4-4cff-9d9c-d29f13d653c4",
                            CreatedAt = new DateTime(2024, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateOfBirth = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("55555555-eeee-eeee-eeee-eeeeeeeeeeee"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "758b70c6-ff9c-4c57-9880-614abcdc6ac6",
                            CreatedAt = new DateTime(2024, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateOfBirth = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("66666666-ffff-ffff-ffff-ffffffffffff"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "f0cec8f3-c2a8-4570-a278-c17913275573",
                            CreatedAt = new DateTime(2024, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateOfBirth = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("IMS.Models.Common.Offer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CandidateId = new Guid("33333333-aaaa-aaaa-aaaa-aaaaaaaaaaaa"),
                            ContactPeriodFrom = new DateTime(2025, 3, 20, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(2183),
                            ContactPeriodTo = new DateTime(2026, 3, 20, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(2451),
                            ContactTypeId = new Guid("11111111-1111-1111-1111-111111111111"),
                            DepartmentId = new Guid("11111111-aaaa-aaaa-aaaa-aaaaaaaaaaaa"),
                            DueDate = new DateTime(2025, 3, 27, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(1821),
                            InterviewId = new Guid("aaaa1111-1111-1111-1111-aaaaaaaaaaaa"),
                            LevelId = new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"),
                        ...
                        new
                        {
                            ...
                            CandidateId = new Guid("44444444-bbbb-bbbb-bbbb-bbbbbbbbbbbb"),
                            ContactPeriodFrom = new DateTime(2025, 3, 20, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(3088),
                            ContactPeriodTo = new DateTime(2027, 3, 20, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(3090),
                            ContactTypeId = new Guid("22222222-2222-2222-2222-222222222222"),
                            DepartmentId = new Guid("22222222-bbbb-bbbb-bbbb-bbbbbbbbbbbb"),
                            DueDate = new DateTime(2025, 3, 30, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(3083),
                            InterviewId = new Guid("bbbb2222-2222-2222-2222-bbbbbbbbbbbb"),
                            LevelId = new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"),
                        ...
                        new
                        {
                            ...
                            CandidateId = new Guid("55555555-eeee-eeee-eeee-eeeeeeeeeeee"),
                            ContactPeriodFrom = new DateTime(2025, 3, 20, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(3136),
                            ContactPeriodTo = new DateTime(2026, 3, 20, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(3137),
                            ContactTypeId = new Guid("33333333-3333-3333-3333-333333333333"),
                            DepartmentId = new Guid("33333333-cccc-cccc-cccc-cccccccccccc"),
                            DueDate = new DateTime(2025, 3, 25, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(3135),
                            InterviewId = new Guid("cccc3333-3333-3333-3333-cccccccccccc"),
                            LevelId = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"),
                        ...
                        new
                        {
                            ...
                            CandidateId = new Guid("33333333-aaaa-aaaa-aaaa-aaaaaaaaaaaa"),
                            ContactPeriodFrom = new DateTime(2025, 3, 20, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(3178),
                            ContactPeriodTo = new DateTime(2026, 3, 20, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(3179),
                            ContactTypeId = new Guid("11111111-1111-1111-1111-111111111111"),
                            DepartmentId = new Guid("11111111-aaaa-aaaa-aaaa-aaaaaaaaaaaa"),
                            DueDate = new DateTime(2025, 4, 3, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(3177),
                            InterviewId = new Guid("aaaa1111-1111-1111-1111-aaaaaaaaaaaa"),
                            LevelId = new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"),
                        ...
                        new
                        {
                            ...
                            CandidateId = new Guid("33333333-aaaa-aaaa-aaaa-aaaaaaaaaaaa"),
                            ContactPeriodFrom = new DateTime(2025, 3, 20, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(3194),
                            ContactPeriodTo = new DateTime(2027, 3, 20, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(3194),
                            ContactTypeId = new Guid("22222222-2222-2222-2222-222222222222"),
                            DepartmentId = new Guid("22222222-bbbb-bbbb-bbbb-bbbbbbbbbbbb"),
                            DueDate = new DateTime(2025, 3, 30, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(3192),
                            InterviewId = new Guid("bbbb2222-2222-2222-2222-bbbbbbbbbbbb"),
                            LevelId = new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"),
