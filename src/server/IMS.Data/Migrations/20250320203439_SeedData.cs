    ...
    public partial class SeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), 0, null, "beba586a-e7ca-4284-9c2d-adab20eb8812", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, null, "admin@example.com", true, "Admin", 2, false, false, false, null, "ADMIN@EXAMPLE.COM", "ADMIN", "AQAAAAEAACcQAAAAEKzO7BHEb758wHgIVI3x0NuSEd8BLlECa+TDvKAF1cUtkj6O5hM9PMp42jCeWnGeww==", null, false, "SECURITY_STAMP_1", false, null, null, "admin" },
                    { new Guid("22222222-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), 0, null, "108ef164-80a7-42ec-9447-f0c633bf0264", new DateTime(2024, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, null, "recruiter@example.com", true, "Recruiter", 2, false, false, false, null, "RECRUITER@EXAMPLE.COM", "RECRUITER", "AQAAAAEAACcQAAAAEOTNmM1M0OJV+VJyKbHIj8b7oJSH/W5uTr8LQy8HO8bhEIb9ZDf9m1KwnBavT5m9Yg==", null, false, "SECURITY_STAMP_2", false, null, null, "recruiter" },
                    { new Guid("33333333-cccc-cccc-cccc-cccccccccccc"), 0, null, "74f95d79-1d2e-4d4c-909a-cb420471e376", new DateTime(2024, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, null, "interviewer@example.com", true, "Interviewer", 2, false, false, false, null, "INTERVIEWER@EXAMPLE.COM", "INTERVIEWER", "AQAAAAEAACcQAAAAEM41t5RUbsvo9ImUsQhuLuI0RLJRt5t7HAVUPnU9Z3naZud31HsypTKOyjmD1tv/UQ==", null, false, "SECURITY_STAMP_3", false, null, null, "interviewer" },
                    { new Guid("44444444-dddd-dddd-dddd-dddddddddddd"), 0, null, "0150892f-8ca4-4cff-9d9c-d29f13d653c4", new DateTime(2024, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, null, "manager@example.com", true, "Manager", 2, false, false, false, null, "MANAGER@EXAMPLE.COM", "MANAGER", "AQAAAAEAACcQAAAAELbr2xCUqc37Qu/fRYpRYOQTzUtPnCVXx7muwkJEhUlRlhGuAGD2kJzcIokmv4YrZQ==", null, false, "SECURITY_STAMP_4", false, null, null, "manager" },
                    { new Guid("55555555-eeee-eeee-eeee-eeeeeeeeeeee"), 0, null, "758b70c6-ff9c-4c57-9880-614abcdc6ac6", new DateTime(2024, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, null, "interview2@example.com", true, "Interviewer 2", 2, false, false, false, null, "INTERVIEW2@EXAMPLE.COM", "INTERVIEW2", "AQAAAAEAACcQAAAAEM41t5RUbsvo9ImUsQhuLuI0RLJRt5t7HAVUPnU9Z3naZud31HsypTKOyjmD1tv/UQ==", null, false, "SECURITY_STAMP_5", false, null, null, "interview2" },
                    { new Guid("66666666-ffff-ffff-ffff-ffffffffffff"), 0, null, "f0cec8f3-c2a8-4570-a278-c17913275573", new DateTime(2024, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, null, "interviewer3@example.com", true, "Interviewer 3", 2, false, false, false, null, "INTERVIEWER3@EXAMPLE.COM", "INTERVIEWER3", "AQAAAAEAACcQAAAAEM41t5RUbsvo9ImUsQhuLuI0RLJRt5t7HAVUPnU9Z3naZud31HsypTKOyjmD1tv/UQ==", null, false, "SECURITY_STAMP_6", false, null, null, "interviewer3" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), new Guid("44444444-dddd-dddd-dddd-dddddddddddd"), 1500.00m, new Guid("33333333-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), new DateTime(2025, 3, 20, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(2183), new DateTime(2026, 3, 20, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(2451), new Guid("11111111-1111-1111-1111-111111111111"), new Guid("11111111-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), new DateTime(2025, 3, 27, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(1821), new Guid("aaaa1111-1111-1111-1111-aaaaaaaaaaaa"), new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), "Offer for Backend Developer position", new Guid("77777777-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), new Guid("22222222-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), 5 },
                    { new Guid("22222222-cccc-cccc-cccc-cccccccccccc"), new Guid("44444444-dddd-dddd-dddd-dddddddddddd"), 2000.00m, new Guid("44444444-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), new DateTime(2025, 3, 20, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(3088), new DateTime(2027, 3, 20, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(3090), new Guid("22222222-2222-2222-2222-222222222222"), new Guid("22222222-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), new DateTime(2025, 3, 30, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(3083), new Guid("bbbb2222-2222-2222-2222-bbbbbbbbbbbb"), new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"), "Offer for Business Analyst position", new Guid("88888888-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), new Guid("22222222-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), 4 },
                    { new Guid("33333333-dddd-dddd-dddd-dddddddddddd"), new Guid("33333333-cccc-cccc-cccc-cccccccccccc"), 1200.00m, new Guid("55555555-eeee-eeee-eeee-eeeeeeeeeeee"), new DateTime(2025, 3, 20, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(3136), new DateTime(2026, 3, 20, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(3137), new Guid("33333333-3333-3333-3333-333333333333"), new Guid("33333333-cccc-cccc-cccc-cccccccccccc"), new DateTime(2025, 3, 25, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(3135), new Guid("cccc3333-3333-3333-3333-cccccccccccc"), new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), "Offer for Tester position", new Guid("99999999-cccc-cccc-cccc-cccccccccccc"), new Guid("22222222-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), 2 },
                    { new Guid("44444444-eeee-eeee-eeee-eeeeeeeeeeee"), new Guid("44444444-dddd-dddd-dddd-dddddddddddd"), 1600.00m, new Guid("33333333-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), new DateTime(2025, 3, 20, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(3178), new DateTime(2026, 3, 20, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(3179), new Guid("11111111-1111-1111-1111-111111111111"), new Guid("11111111-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), new DateTime(2025, 4, 3, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(3177), new Guid("aaaa1111-1111-1111-1111-aaaaaaaaaaaa"), new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), "Second offer for Backend Developer position", new Guid("77777777-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), new Guid("22222222-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), 4 },
                    { new Guid("55555555-ffff-ffff-ffff-ffffffffffff"), new Guid("44444444-dddd-dddd-dddd-dddddddddddd"), 2100.00m, new Guid("33333333-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), new DateTime(2025, 3, 20, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(3194), new DateTime(2027, 3, 20, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(3194), new Guid("22222222-2222-2222-2222-222222222222"), new Guid("22222222-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), new DateTime(2025, 3, 30, 20, 34, 38, 82, DateTimeKind.Utc).AddTicks(3192), new Guid("bbbb2222-2222-2222-2222-bbbbbbbbbbbb"), new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"), "Second offer for Business Analyst position", new Guid("88888888-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), new Guid("22222222-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), 4 }
                });
        }
